...
OUT=A+'clean/'
PREV='/tmp/claude-0/-home-user-my-soundboard/0bae543d-54b7-5c74-b4f4-c802d116c901/scratchpad/work/explainer-fix/cut/'
...
HAND_S=[(738,935),(790,928),(840,924),(878,935),(897,975),(895,1050),(892,1100),(890,1112),(888,1130),(880,1140),(860,1148),(830,1152),(800,1160),(780,1172),(765,1195),(756,1225),(748,1250),(740,1280),(736,1310),(738,1335),(770,1350),(805,1365),(838,1400),(848,1450),(850,1500),(850,1708)]  # sloth side: runs through the transparent gap right of the panda hand/arm
...
FEATHER=1.6
WIDE=5.0            # sigma for occlusion seams (~10-12 px ramp)
# group-coordinate rectangles (x0,y0,x1,y1)
SOFT_ZONES={        # straight occlusion seams that should read as fur ending, not as a cut
 'sloth-pair': [(696,560,748,940),(720,900,905,965)],   # big sloth's left arm: vertical edge behind the panda mane, horizontal edge behind the panda hand
 'sloth-small': [(876,670,930,1245)],                   # small sloth's left body edge against the big sloth
}
